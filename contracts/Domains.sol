...
contract Domains is ERC721URIStorage {
    ...
    function register(string calldata name) public payable {
        ...
        // Created json metadata of NFT
        string memory json = Base64.encode(
            abi.encodePacked(
                '{"name": "',
                _name,
                '", "description": "A domanin on the Naruto name service", "image": "data:image/svg+xml;base64,',
